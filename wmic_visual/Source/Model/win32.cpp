...
IEnumWbemClassObject* Win32Objs::init(const char* win32_class, HRESULT& hres) {
...
HRESULT Win32Objs::getString(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, string& str) {
	HRESULT hres;
...
char** Win32Objs::getStringCarrays(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, HRESULT& hres) {
	char** str;
	SAFEARRAY* s_array;
	BSTR* ptr_bstr;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
...
vector<char*> Win32Objs::getVectorChars(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, HRESULT& hres) {
	vector<char*> vet_str;
	SAFEARRAY* s_array;
	BSTR* ptr_bstr;
	char** temp;
...
vector<uint16_t> Win32Objs::getVectorU16(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, HRESULT& hres) {
...
HRESULT Win32Objs::getBoolean(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, bool& b) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		b = false;
...
HRESULT Win32Objs::getuInt16(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, uint16_t& value) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		value = 0;
...
HRESULT Win32Objs::getuInt32(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, uint32_t& value) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		value = 0;
...
HRESULT Win32Objs::getInt32(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, int32_t& value) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		value = 0;
...
HRESULT Win32Objs::getInt64(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, uint64_t& value) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		value = 0;
...
HRESULT Win32Objs::getuInt64(BSTR field, VARIANT* vtProp, IWbemClassObject* pclsObj, uint64_t& value) {
	HRESULT hres;
	hres = pclsObj->Get(field, 0, vtProp, 0, 0);
	if (vtProp->vt == 1)
		value = 0;
